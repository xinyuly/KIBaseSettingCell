...
/*!
 cell的style
 */
typedef NS_ENUM(NSUInteger, KIBaseSettingCellStyle) {
    /*!
...
/**
 *  KIBaseSettingTableViewCellDelegate
 */
@protocol KIBaseSettingTableViewCellDelegate <NSObject>
...
@interface KIBaseSettingTableViewCell : UITableViewCell
...
@property(nonatomic, weak) id<KIBaseSettingTableViewCellDelegate> baseSettingTableViewDelegate;
...
//设置cell的style
- (void)setCellStyle:(KIBaseSettingCellStyle)style;
